...
describe('PayFlow — Validation & Edge Case Tests', () => {
  ...
  it('RULE: Valid standard 8h shift passes validation', async () => {
    const res = await processRow(baseValidRow);
  ...
  it('RULE: Zero hourly rate is flagged as invalid', async () => {
  ...
  it('RULE: Non-numeric hourly rate is flagged as invalid', async () => {
  ...
  it('RULE: Invalid date format is flagged as invalid', async () => {
  ...
  it('RULE: Future date is flagged as invalid', async () => {
  ...
  it('RULE: Invalid clock_in format is flagged as invalid', async () => {
  ...
  it('RULE: Invalid clock_out format is flagged as invalid', async () => {
  ...
  it('RULE: clock_out equal to clock_in is flagged as invalid (zero duration)', async () => {
  ...
  it('RULE: clock_out before clock_in is flagged as invalid (overnight shifts rejected by rule)', async () => {
  ...
  it('RULE: Daily overtime calculated correctly for 10h shift at ₹300/hr', async () => {
    const shift10h: RawRow = { ...baseValidRow, clock_in: '08:00', clock_out: '18:00', hourly_rate: '300' };
    const res = await processRow(shift10h);
    assert.equal(res.validationStatus, 'valid');
